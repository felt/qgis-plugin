...
class RecentMapsModelTest(unittest.TestCase):
    ...
    def test_pretty_date(self):
        ...
        self.assertEqual(model.pretty_format_date(one_minute_ago),
                         "1 minute ago")

        ten_minutes_ago = now.addSecs(-10 * 60)
        self.assertEqual(model.pretty_format_date(ten_minutes_ago),
                         "10 minutes ago")
        ...
        self.assertEqual(model.pretty_format_date(three_hours_ago),
                         "3 hours ago")
        ...
        self.assertEqual(model.pretty_format_date(three_months_ago),
                         "3 months ago")
        ...
        self.assertEqual(model.pretty_format_date(two_years_ago),
                         "2 years ago")
